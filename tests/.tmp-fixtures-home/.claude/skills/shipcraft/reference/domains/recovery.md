...
Recovery is the deploy's second half: the rollback — the way back — that makes every deploy a
promise the team can keep. The rule: **rollback is a feature, shipped and rehearsed — not a document.**
